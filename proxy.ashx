...
public class ProxyConfig
{
    ...
    public static ProxyConfig GetCurrentConfig()
    {
        ...
        if (config == null)
        {
            string fileName = GetFilename(HttpContext.Current);// "proxy.config";//
    ...
    public static string GetFilename(HttpContext context)
    {
        ...
        //=FAIL --Server Error in Application "DEFAULT WEB SITE/A/CHARLIE" - HTTP Error 403.0 - Forbidden --You do not have permission to view this directory or page.
        
        //return context.Server.MapPath("/a/proxy.config");
        //=FAIL --localhost:80 HTTP Error 403.0 - Forbidden. You do not have permission to view this directory or page.
        
        //return Path.Combine(HttpContext.Current.Server.MapPath("~"), "../proxy.config");
        //=FAIL --Proxy.config file does not exist at application root, or is not readable. with or w/o ../
        
        //return context.Server.MapPath("~/App_Data/proxy.config");
        //=FAIL --Proxy.config file does not exist at application root, or is not readable.
        
        //return context.Server.MapPath("~/App_Data/proxy_config.xml");
        //=FAIL --Proxy.config file does not exist at application root, or is not readable.
        
        //return context.Server.MapPath("/proxy.config");
        //=FAIL --Server Error in '/a/charlie' Application. Proxy.config file does not exist at application root, or is not readable.
        
        //return context.Server.MapPath(@"d:\app\www\maps\charlie\proxy.config");//=OK WORKED ***BUT SAME AS MapPath ~/ output!
        //return System.Web.Hosting.HostingEnvironment.MapPath("~/proxy.config");//=FAIL --ERROR 403
    }
    #endregion
