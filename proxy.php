<?php
  ...
  $serverUrls = array(
    ...
    array( 'url' => 'http://orthogonal.esri.com/arcgis/rest/services/', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://hummer/ArcGIS/rest/services', 'matchAll' => true, 'token' => '' ),
    ...
    array( 'url' => 'http://explorer.arcgis.com/arcgis/rest/services/', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://www.arcgis.com/sharing', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://utility.arcgis.com/sharing', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://a.tile.openstreetmap.org//', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://b.tile.openstreetmap.org//', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://c.tile.openstreetmap.org//', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://serverapi.arcgisonline.com/veadaptor/production/services/', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://egisws02.nos.noaa.gov/ArcGIS/rest/services/', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://imaps.dfg.ca.gov/arcgis/rest/services/', 'matchAll' => true, 'token' => '' ),
    array( 'url' => 'https://map.dfg.ca.gov/arcgis/rest/services/', 'matchAll' => true, 'token' => '' )
  );
  /***************************************************************************/
